...
# ----------------------------
# Convert markdown newsletter to a smooth audio script
# ----------------------------
...
# ----------------------------
# OpenAI client helper (uses Streamlit secrets)
# ----------------------------
...
def streamlit_main():
    ...
    if st.session_state.get("newsletter"):
        ...
        if not effective_eleven_key:
            st.info(
                "To generate audio, set ELEVENLABS_API_KEY in Streamlit secrets "
